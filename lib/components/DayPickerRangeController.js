...
function (_ref) {
  ...
  _proto.getFirstFocusableDay = function getFirstFocusableDay(newMonth) {
    ...
    var focusedDate = newMonth.clone().startOf('jMonth');
    ...
    if (this.isBlocked(focusedDate)) {
      var days = [];
      var lastVisibleDay = newMonth.clone().add(numberOfMonths - 1, 'months').endOf('jMonth');
  ...
  _proto.addModifierToRange = function addModifierToRange(updatedDays, start, end, modifier) {
    ...
    // console.log('_isBeforeDay["default"]', (0, _isBeforeDay["default"])(spanStart, end))
