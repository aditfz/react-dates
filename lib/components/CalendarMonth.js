...
function (_ref) {
  ...
  function CalendarMonth(props) {
    ...
    _this.state = {
      weeks: (0, _getCalendarMonthWeeks["default"])(momentJalaali(props.month), props.enableOutsideDays, props.firstDayOfWeek == null ? _moment["default"].localeData().firstDayOfWeek() : props.firstDayOfWeek)
    };
    ...
    return _react["default"].createElement("div", (0, _extends2["default"])({}, (0, _reactWithStyles.css)(styles.CalendarMonth, {
      ...
      return _react["default"].createElement(_CalendarWeek["default"], {
        ...
        return renderCalendarDay({
          ...
          day: day,
          daySize: daySize,
          isOutsideDay: !day || momentJalaali(day).format("jMM") !== momentJalaali(month).format("jMM") ,
